; Proc12 . Описать процедуру SortInc3( A , B , C ), меняющую содержимое переменных 
; A , B , C таким образом, чтобы их значения оказались упорядоченными
; по возрастанию ( A , B , C — вещественные параметры, являющиеся
; одновременно входными и выходными). С помощью этой процедуры упорядочить 
; по возрастанию два данных набора из трех чисел: ( A 1 , B 1 , C 1 ) и ( A 2 , B 2 , C 2 ).
;
; Вывод:
; 5, 6, 7
; 15, 17, 26
