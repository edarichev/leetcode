...
; функцию Dist( x P , y P , x A , y A , x B , y B ) вещественного типа, находящую 
; расстояние D ( P , AB ) от точки P до прямой AB по формуле
; D ( P , AB ) = 2· S PAB /| AB |,
; где S PAB — площадь треугольника PAB . С помощью этой функции найти
