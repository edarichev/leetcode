; Minmax7. Дано целое число N и набор из N целых чисел. Найти номера первого
...
main:
        ...
        mov     r10, -1         ; № мин
        mov     r11, -1         ; № макс
        ; первый максимальный: строго jg, тогда индекс останется на первом
        ; последний минимальный: нестрогое jle, тогда индекс будет сдвигаться
loop_i:
        cmp     rcx, N
        je      done
        mov     rax, qword [rsi]
